...
function price() { 
	...
	register_post_type( 'price', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Price box', 'bonestheme' ), /* This is the Title of the Group */
			...
			'rewrite'	=> array( 'slug' => 'price', 'with_front' => false ), /* you can specify its url slug */
