...
function workshops() { 
	...
	register_post_type( 'workshops', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'add_new' => __( 'Add New workshop', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New workshops', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit workshop', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New workshop', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View workshop', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search workshops', 'bonestheme' ), /* Search Custom Type Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'Workshops custom post type', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
