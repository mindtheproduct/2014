...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.scrollparallax.js" type="text/javascript"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.inview.js" type="text/javascript"></script>
